...
console.log(findMin(58, 35, 92, 10, 77)); // 10
...
function combinedExample(firstParam, ...restOfParams) {
  ...
  console.log(`나머지 매개변수의 형태는 무엇입니까?: ${Array.isArray(restOfParams)}`);
}
...
function defaultParams(param1 = defaultBalue1, para2 = defaultValue2) {
