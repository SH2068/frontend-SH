...
// else if문의 예시
// 나이가 8살 미만 '어린이 입니다.' 출력
// 나이가 8살 이상 20살 미만 '청소년 입니다.' 출력
// 나이가 20살 이상 '성인입니다.' 출력
...
if (cheese) {
  console.log("Cheese availalbe for making cheese on toast.");
} else {
...
// 표현식의 값을 확인하고 해당 값과 일치하는 case 문의 코드블록을 실행

// switch문은 여러 가지 가능한 케이스 중 하나를 선택하여
// 해당하는 코드 블록을 싫애하는 제어 구조
