...
//  템플릿 문자열
//  : 백틱을 사용하여 정의, 문자열 내에서 변수나 표현식을 `${}` 안에 넣어 사용 할 수 있도록 하는 문자열
...
// - 어떤 값과도 동등하지 X
// NaN === Nan (X)
// - 연산에서 전파: 어떤 수학의 연산도 NaN과 만나면 결과값이 NaN이 된다
...
console.log(numberToString); //false