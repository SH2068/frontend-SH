...
function checkType<T>(value: T): Check<T> {
 return typeof value === 'string' ? 'String' : 'String' as Check<T> : 'Not a String' as Check<T>;
}

// 타입 단언
// : 타입스크립트에게 개발자가 특정 값의 타입임을 알고 있음을ㅈ ㅓㄴ달
// : 컴파일러가 타입을 정확하게 추론하지 못하는 경우
// : 개발자가 구체적인 타입을 프로그램에게 전달

// 각주 문법(as)
let someValue: any = 'this is a string';
let strLenghth: number = someValue.length;
