...
moveUp = 'down';
// let moveBottoms: Directions = 'bottom'; -type Error

// 함수 인자로서의 리터럴 타입 지정으로 함수 인자를 특정 값으로 제한
function seetAlignment(alignment: 'left' | 'right' | 'center'): void {
  // 함수 내용
}
...
// 리터럴 타입은 구체적인 값을 방지하거나, 특정 값들만 허용하는 로직 설계에 유용
