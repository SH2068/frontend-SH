...
// 인덱스를 사용하여 배열 뒷부분에 특정 위치에 요소 추가
cars[7] = 'kia';
console.log(cars);
...
//! 요소 제거
// pop()메소드의 경우 마지막 욧오를 제거하고 그 값을 반환
...
// 배열.alpice(start, deleteCount, item1, item2, ...);

// start(필수값): 변경을 시작할 인덱스 번호
// : 해당 시작 인덱스부터 요소가 제거되거나 새로운 요소가 삽입

// deletCount(선택): 제거할 요소의 개수
...
let slicedCars = cars.slice(1, 4); // 인덱스 번호 1, 2, 3 이 추출
console.log(slicedCars);
console.log(cars); // 요소 6개의 배열이 변함 X
