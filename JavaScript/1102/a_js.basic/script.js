...
// if문, switch문 등등 문으로 끝나는 키워드들은 statment의 문장에서 나온 의미
...
// : 식별자 이름 시작으로 언더 스코어는 사용 하지 않는 것을 권장
// 공백 문자 사용 X
...
//? 4-1. 알림 창(대화상자) 출력 (alert: 알리다, 경고하다)

// alert() 함수 사용
// : 소괄호 안에 출력할 메시지시를 입력(매개변수, parameter)
alert('Hello World!');
...
// 괄호 안에는 실제 웹 브라우저 화면에 표시 할 내용(HTML 태그 사용 가능), 어떤 결괏값이 저장된 변수 삽입 가능
// document.write('');
