...
console.log(num1 == num2); // true(타입고려 X) 
console.log(num1 != num2); // false(타입고려 X) 

console.log(num1 === num2); // false(타입고려 O) 
console.log(num1 !== num2); // true(타입고려 O) 
